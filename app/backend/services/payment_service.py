...
class PaymentService:
    def payout_to_payoneer(self, db: Session, user_id: int, amount: float) -> schemas.TransactionInDB:
        """
        ...
        updated_transaction = crud.transaction.update(db, db_obj=db_transaction, obj_in={"status": "completed", "provider_transaction_id": provider_id})
